    ...
    if ($stmt = mysqli_prepare($dbc, $query)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $data .= '<div class="table-responsive">
                    ...
                    <div class="row g-2"> 
                        <div class="col-md-8">
                            <button type="button" class="btn btn-primary btn-lg w-100 shadow-sm" name="submit" id="create-poll-image-select-answers"><i class="fa-regular fa-circle-check"></i> Create Answers</button>
                        </div> 
                        <div class="col-md-4">
                          	<button type="button" class="btn btn-light-gray btn-lg w-100 shadow-sm" name="add-poll-image-select-answer" id="add-poll-image-select-answer"><i class="fa-solid fa-circle-plus"></i> Row</button>
                        </div>
                    </div>';
...
$(document).ready(function(){ 
	...
	$('#add-poll-image-select-answer').click(function(){  
		$("#sortable_create_image_select_row").sortable({
			axis: "y",
			helper: function(e, tr)
			  {
	...
	$('#create-poll-image-select-answers').click(function(){
		...
		if (response_answer_text.length === 0) {
			...
			$.ajax({ 
				...
				success:function(data){
					...
					$("#create-poll-image-select-answers").prop("disabled", false);
					$("#create-poll-image-select-answers").html('<i class="fa-solid fa-cloud"></i> Save');
