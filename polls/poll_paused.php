...
if(isset($_POST['selected_values'])){
	...
	$query = "UPDATE poll_inquiry SET inquiry_status = 'Paused' WHERE inquiry_id IN ($placeholders)";
    ...
    $query = "UPDATE poll_inquiry SET inquiry_status = 'Paused' WHERE inquiry_id = ?";
    $stmt = mysqli_prepare($dbc, $query);
