...
if (isset($_SESSION['id']) && isset($_POST['inquiry_id'])) {
    ...
    $inquiry_overview = strip_tags($_POST['inquiry_overview']); 
    ...
    $query = "UPDATE poll_inquiry SET inquiry_name = ?, inquiry_info = ?, inquiry_overview = ?, inquiry_question = ?, inquiry_status = ?, inquiry_image = ? WHERE inquiry_id = ?";
    $stmt = mysqli_prepare($dbc, $query);
    mysqli_stmt_bind_param($stmt, 'ssssssi', $inquiry_name, $inquiry_info, $inquiry_overview, $inquiry_question, $inquiry_status, $inquiry_image, $inquiry_id);
