...
<script>
$(document).ready(function(){
	$("#search_admin_poll_reports").on("keyup", function() {
		if ($("#search_admin_poll_reports").val() == ''){
			$(".input-group-text.admin-poll-reports-search").find('.fa').removeClass('fa-times-circle').addClass("fa-search");
		} else {
			$(".input-group-text.admin-poll-reports-search").find('.fa').removeClass('fa-search').addClass("fa-times-circle");
			...
			$data .='<div class="accordion-item border mb-2">
	 		      		...
	 		      		<button type="button" class="accordion-button d-flex justify-content-between align-items-center collapsed" style="padding: 0.5rem;" data-bs-toggle="collapse" data-bs-target="#accord_'.$inquiry_id.'" aria-expanded="false" aria-controls="flush-collapseOne">
							...
							if($inquiry_status == "Active"){
	                    		...
	                    		$data .='<span class="btn btn-light btn-sm bg-cool-ice ms-2 me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="Completed" style="width:50px;" disabled><i class="fa-solid fa-check-to-slot"></i></span>';
	 		    			...
	 		    			$data .='</h2>
	 		    					 <div id="accord_'.$inquiry_id.'" class="accordion-collapse collapse" data-bs-parent="#accordionPollReports">
										...
										$data .='<div class="fw-bold fs-5 dark-gray mt-2">'.$inquiry_question.' <button type="button" class="btn btn-light-gray btn-sm float-end" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="Statistics" onclick="readPollReportStatDetails('.$inquiry_id.');"><i class="fa-solid fa-chart-bar"></i></button>
											</div>';
													...
													$data .='<div class="h-100 p-4 text-bg-dark rounded-3 mb-3">
								   								<div class="d-flex align-items-center text-break">
								   									<div class="flex-shrink-0">
								   										<img src="img/poll_images/crown.png" alt="" class="img-fluid img-thumbnail rounded-circle shadow-sm" style="width:90px;">
								   									</div>
