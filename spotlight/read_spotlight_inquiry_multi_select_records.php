	...
	$data .='<form name="create_multi_answers_form" id="create_multi_answers_form">';
		...
		if (mysqli_num_rows($result) > 0) {
			...
			$data .='<div class="table-responsive">
						...
						<div class="row g-2"> 
							<div class="col-md-8">
								<button type="button" class="btn btn-primary btn-lg w-100 shadow-sm" name="submit" id="create-spotlight-multi-answers"><i class="fa-regular fa-circle-check"></i> Create Answers</button>
							</div> 
							<div class="col-md-4">
								<!-- 
								...
								<button type="button" class="btn btn-light-gray btn-lg w-100 shadow-sm" name="add-spotlight-multi-answer" id="add-spotlight-multi-answer"><i class="fa-solid fa-circle-plus"></i> Row</button>
							</div>
						</div>';
...
$(document).ready(function(){ 
	...
	$('#add-spotlight-multi-answer').click(function(){  
	...
	$('#create-spotlight-multi-answers').click(function(){
		...
		if (response_answer_text.length === 0) {
			...
			$("#create-spotlight-multi-answers").prop("disabled", true);
			$(this).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Saving...');
		
			$.ajax({ 
				method:"POST",
				url: "ajax/spotlight/create_spotlight_multi_answers.php",
				...
				success:function(data){
					...
					$("#create-spotlight-multi-answers").prop("disabled", false);
					$("#create-spotlight-multi-answers").html('<i class="fa-solid fa-cloud"></i> Save');
