...
if (isset($_SESSION['id'])) {
    ...
    if (!$result = mysqli_query($dbc, $query)) {
     	error_log('Read Past Winners - Query Error: ' . mysqli_error($dbc) . ' | Query: ' . $query);
        
    	$data .= '<div class="alert alert-danger">Unable to load past winners. Please try again later.</div>';
    } else {
