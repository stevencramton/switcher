...
if (isset($_POST['link_full_name'])) {
    ...
    $display_query = "SELECT * FROM links_rsb_weblinks";
    ...
    $query = "INSERT INTO links_rsb_weblinks (link_display_order, link_full_name, link_description, link_url, link_image, link_created_by, link_icon, favorite, new_tab, link_protocol) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
