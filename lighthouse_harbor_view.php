...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header("Location: lighthouse_harbor.php");
    exit();
}
...
/* CRITICAL: Hide the native file input completely */
.file-input-hidden {
...
.drop-zone-view .browse-link:hover {
    color: #2563eb;
}
							...
							<div class="content-section">
							    <div class="section-title" style="display: flex; align-items: center; justify-content: space-between;">
							        ...
							        <button type="button" 
							                ...
							                style="background: #10b981; color: white; border: none; padding: 6px 12px; border-radius: 6px; font-size: 12px; cursor: pointer; transition: all 0.3s ease; display: flex; align-items: center; gap: 2px;">
							    ...
							    <div class="no-attachments">
							        <i class="fa-solid fa-paperclip mx-auto"></i>
...
$(document).ready(function() {
    ...
    // Initialize TinyMCE when edit modal is shown (not on page load to prevent flickering)
    ...
    if (editSignalModal) {
        ...
        // Clean up TinyMCE when modal is hidden to prevent memory leaks
        editSignalModal.addEventListener('hidden.bs.modal', function() {
            if (tinyMCEInitialized && tinymce.get('edit_signal_message_content')) {
                tinymce.get('edit_signal_message_content').remove();
