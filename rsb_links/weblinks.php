...
function createWeblink() {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo json_encode(['success' => false, 'message' => 'Failed to create weblink: ' . mysqli_error($dbc)]);
    }
}
...
function updateWeblink() {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo json_encode(['success' => false, 'message' => 'Failed to update weblink: ' . mysqli_error($dbc)]);
    }
}
