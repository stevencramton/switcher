...
if(isset($_SESSION['id'])) {
	...
	if ($stmt = mysqli_prepare($dbc, $query)) {
    	...
    	if (mysqli_num_rows($result) > 0) {
            ...
            $data .= '<span class="list-group-item count-open-request-item shadow-sm border bg-dark text-white rounded d-flex p-3 mb-1" id="' . $link_request_id . '" aria-current="true">
                            ...
                            <div>
                                ...
                                <p class="mb-0">
                                    <code style="color:#ff4ea6;">
                                        <span class="">Requested by: ' . $link_request_sender . ' on: ' . $link_request_time . '</span>
                                    </code>
                                </p>
                            </div>
     	...
     	$data .= '<svg version="1.1" class="svgcheck" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2" style="margin: 50px auto 0 !important;">
                  ...
                  <p class="complete mb-5">Link requests not found!</p>';
    	}
