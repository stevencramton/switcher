...
$valid_filters = ['my_signals', 'all', 'assigned', 'closed'];
											...
											<div class="col-md-6">
												<div class="mb-3">
													...
													<select name="signal_type" class="form-select" required>
														...
														<option value="general_request" selected>General</option>
...
let currentFilters = {
	...
	priority: null,
	owner: <?php echo $url_filter ? json_encode($url_filter, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP) : "null"; ?>,
	search: ''
};
