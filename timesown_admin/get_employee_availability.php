...
try {
    ...
    echo json_encode([
        ...
        'debug_info' => [
            'raw_time_preferences_count' => count($time_preferences),
            'raw_availability_ranges_count' => count($availability_ranges),
            'final_availability_count' => count($all_availability)
        ],
        'statistics' => [
