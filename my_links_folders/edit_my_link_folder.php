...
if (isset($_POST['my_folder_id'])) {
    ...
    $query = "UPDATE my_links_folders SET my_folder_name = ?, my_folder_description = ? WHERE my_folder_id = ?";
    if ($stmt = mysqli_prepare($dbc, $query)) {
        mysqli_stmt_bind_param($stmt, 'sss', $my_folder_name, $my_folder_description, $my_folder_id);
