...
try {
    ...
    error_log('Tenant deletion error (Tenant ID: ' . $tenant_id . '): ' . $e->getMessage());
    
    echo json_encode([
        'success' => false,
        'message' => 'An error occurred while deleting the organization. Please try again or contact support.'
    ]);
}
?>