...
try {
    ...
    if (!mysqli_stmt_execute($stmt)) {
     	error_log('Create Tenant - Insert Error: ' . mysqli_error($dbc) . ' | Name: ' . $name . ' | Slug: ' . $slug);
	...
	error_log('Create Tenant - Exception: ' . $e->getMessage() . ' in ' . $e->getFile() . ' on line ' . $e->getLine());
